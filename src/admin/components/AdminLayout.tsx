...
interface AdminLayoutProps {
  ...
  activeTab?: 'calendar' | 'appointments' | 'services' | 'barbers' | 'customers' | 'activity' | 'reports' | 'profile';
  children: React.ReactNode;
}

export const AdminLayout: React.FC<AdminLayoutProps> = ({ onLogout, activeTab = 'calendar', children }) => {
